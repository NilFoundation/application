...
public:
    ...
    void find_and_access() {
        for (int i = 0; i < LOOP_INTERACTIONS; i++) { // atomic
            ...
            if (a1) {
                typedef boost::function2<shared_ptr<my_msg_aspect_test>, shared_ptr<my_msg_aspect_test>,
            ...
            if (a2) {
                typedef boost::function2<shared_ptr<my_sum_aspect_test>, shared_ptr<my_sum_aspect_test>,
...
BOOST_AUTO_TEST_SUITE(aspect_map_test_suite)
    ...
    BOOST_AUTO_TEST_CASE(aspect_map_insert_find_size_test) {
        application::aspect_map my_aspect_map;
        shared_ptr<my_msg_aspect_test> res = my_aspect_map.insert<my_msg_aspect_test>(
                boost::make_shared<my_msg_aspect_test>("HI"));
    ...
    BOOST_AUTO_TEST_CASE(aspect_map_insert_test) {
        application::aspect_map my_aspect_map;
        shared_ptr<my_msg_aspect_test> res1 = my_aspect_map.insert<my_msg_aspect_test>(
                boost::make_shared<my_msg_aspect_test>("HI"));
        shared_ptr<my_msg_aspect_test> res2 = my_aspect_map.insert<my_msg_aspect_test>(
                boost::make_shared<my_msg_aspect_test>("HI HI"));
