...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    // way 2
    this_application()->insert<limit_single_instance>(boost::make_shared<limit_single_instance_default_behaviour>(
        appuuid, handler<bool>::make_callback(app, &myapp::instace_aready_running)));
