...
public:
    ...
    // param
    int operator()() {
        std::string logfile = this_application()->find<application::path>()->executable_path().string() + "/log.txt";
...
int main(int argc, char *argv[]) {
    ...
    this_application()->insert<application::path>(boost::make_shared<application::path>());
