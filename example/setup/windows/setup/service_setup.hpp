        ...
        namespace example {
            ...
            public:
                ...
                windows_scm(DWORD dw_desired_access) {
                    ...
                    if (ec) {
                        BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR_USING_MY_EC("OpenSCManager() failed", ec);
                    }
                }
            ...
            public:
                ...
                virtual bool exist() {
                    ...
                    if (ec) {
                        BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR_USING_MY_EC("is_installed() failed", ec);
                    }
            ...
            protected:
                ...
                virtual bool is_installed(boost::system::error_code &ec) {
                    ...
                    // Query services
                    BOOL ret_value = EnumServicesStatus(scm.get(), SERVICE_WIN32, SERVICE_STATE_ALL, &service,
                    ...
                    if (!ret_value) {
                        ...
                        if (ERROR_MORE_DATA == GetLastError()) {
                            ...
                            EnumServicesStatus(scm.get(), SERVICE_WIN32, SERVICE_STATE_ALL, pServices, dwBytes,
            ...
            public:
                ...
                virtual void uninstall() {
                    ...
                    if (ec) {
                        BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR_USING_MY_EC("uninstall() failed", ec);
                    }
                }
            ...
            public:
                ...
                template<typename T>
                install_windows_service_(const setup_type<T> &service_name, const setup_type<T> &service_display_name,
                ...
                virtual void install() {
                    ...
                    if (ec) {
                        BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR_USING_MY_EC("install() failed", ec);
                    }
                }
            ...
            protected:
                ...
                void install_service(boost::system::error_code &ec) {
                    ...
                    SERVICE_DESCRIPTION sd = {serviceDescription};
                ...
                void register_application(boost::system::error_code &ec) {
                    ...
                    error = RegCreateKeyEx(HKEY_LOCAL_MACHINE, sub_key.c_str(), 0, NULL, REG_OPTION_NON_VOLATILE,
