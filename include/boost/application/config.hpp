...
#define BOOST_APPLICATION_SOURCE_LOCATION "in file '" __FILE__ "', line " BOOST_STRINGIZE(__LINE__) ": "
...
#define BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR(what)                                                   \
    BOOST_APPLICATION_TROWN_MY_OWN_EXCEPTION(                                                             \
        what " : " + boost::system::error_code(last_error(), boost::system::system_category()).message(), \
        last_error())

#define BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR_USING_MY_EC(what, ec) \
    BOOST_APPLICATION_TROWN_MY_OWN_EXCEPTION(what " : " + ec.message(), ec.value())
...
#define BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR(what)                                                        \
    BOOST_APPLICATION_THROW(                                                                                   \
        boost::system::system_error(boost::system::error_code(last_error(), boost::system::system_category()), \
                                    BOOST_APPLICATION_SOURCE_LOCATION what))

// use this version when you already have the value of 'ec', ie you already
// called 'last_error'.
#define BOOST_APPLICATION_THROW_LAST_SYSTEM_ERROR_USING_MY_EC(what, ec) \
    BOOST_APPLICATION_THROW(boost::system::system_error(ec, BOOST_APPLICATION_SOURCE_LOCATION what))
