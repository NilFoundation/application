...
namespace boost {
    namespace application {
        ...
        namespace detail {
            ...
            template<class T>
            csbl::shared_ptr<T> T_instance<T>::ptr;
            template<class T>
            boost::shared_mutex T_instance<T>::lock;
         ...
         */
        class basic_context : public aspect_map, private boost::noncopyable {
        public:
        ...
        public:
            ...
            static inline csbl::shared_ptr<global_context> create(boost::system::error_code &ec)
                ...
                ec.clear();
                if (already_created()) {
                    ec = boost::system::error_code(boost::system::errc::file_exists, boost::system::generic_category());
            ...
            static inline void destroy(boost::system::error_code &ec)
            ...
            static inline csbl::shared_ptr<global_context> get(boost::system::error_code &ec)
