...
namespace boost {
    namespace application {
        ...
        protected:
            ...
            BOOL send_status_to_scm(DWORD dw_current_state, DWORD dw_check_point, DWORD dw_wait_hint = 1000,
                                    DWORD dw_win32_exit_code = NO_ERROR, DWORD dw_service_specific_exit_code = 0) {
                BOOL success;
            ...
            void work_thread(int argc, char_type **argv) {
                context_.exchange<application::args>(csbl::make_shared<application::args>(argc, argv));
